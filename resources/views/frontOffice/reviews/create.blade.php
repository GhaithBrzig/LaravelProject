                                        ...
                                        @endfor
                                          ...
                                          <div class="form-group row mt-4">
                                             <div class="col feedback">
                                                 <p class="comment_content">{{ $review->comment }}</p><p>{{$review->updated_at}}</p>
                                            </div>
                                            <form method="post" action="{{ route('reviews.update',  $review->id )}}">
                                                @csrf
                                                @method('PUT')
                                                <textarea id="comment" class="form-control edit-comment" value="{{ $review->comment }}" style="display: none;" rows="6" value="{{ $review->comment }}" required>{{ $review->comment }}</textarea>
                                                <button  type="submit" class="btn btn-success save-btn" name="save-btn" style="display: none;"><i class="fa fa-check"></i></button>
                                            </form>
                                          ...
                                          <form method="POST" action="{{ route('reviews.destroy', $review->id) }}" style="display: inline;">
                                            ...
                                            <button type="submit" class="btn btn-danger " onclick="return confirm('Are you sure you want to delete this review?')"><i class="fa fa-trash"></i></i></button>
                                        </form>
                                       
                                        <button  class="btn btn-secondary edit-btn" name="edit-btn" id="{{$review->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
